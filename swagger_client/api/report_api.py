...
class ReportApi(object):
    ...
    def profit_loss_report(self, body, authorization, api_key, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.profit_loss_report_with_http_info(body, authorization, api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.profit_loss_report_with_http_info(body, authorization, api_key, **kwargs)  # noqa: E501
            return data
    ...
    def profit_loss_report_with_http_info(self, body, authorization, api_key, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/trade/v1/profit-loss-report', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
