...
class PositionControllerApi(object):
    ...
    def convert_position(self, body, user_id, source, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.convert_position_with_http_info(body, user_id, source, **kwargs)  # noqa: E501
        else:
            (data) = self.convert_position_with_http_info(body, user_id, source, **kwargs)  # noqa: E501
            return data
    ...
    def convert_position_with_http_info(self, body, user_id, source, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/portfolio/v1/convert-position', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def do_holdings(self, user_id, source, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.do_holdings_with_http_info(user_id, source, **kwargs)  # noqa: E501
        else:
            (data) = self.do_holdings_with_http_info(user_id, source, **kwargs)  # noqa: E501
            return data
    ...
    def get_position_book(self, user_id, source, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_position_book_with_http_info(user_id, source, **kwargs)  # noqa: E501
        else:
            (data) = self.get_position_book_with_http_info(user_id, source, **kwargs)  # noqa: E501
            return data
    ...
    def get_position_book_with_http_info(self, user_id, source, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/portfolio/v1/position-book', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
