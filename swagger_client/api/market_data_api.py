...
class MarketDataApi(object):
    ...
    def get_quote(self, body, authorization, api_key):  # noqa: E501
        ...
        """
        (data) = self.get_quote_with_http_info(body, authorization, api_key)  # noqa: E501
        return data

    def get_quote_with_http_info(self, body, authorization, api_key):  # noqa: E501
        """GetQuoteAPI  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_quote`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='QuotesSuccess',  # noqa: E501
