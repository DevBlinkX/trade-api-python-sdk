...
class OrderHistoryTrails(object):
    ...
    def __init__(self, symbol=None, ord_action=None, pending_qty=None, trigger_price=None, limit_price=None, avg_price=None, dis_qty=None, ord_id=None, ord_desc=None, ord_validity=None, current_ord_status=None, exc=None, traded_qty=None, rej_reason=None, price=None, qty=None, prd_type=None, exch_ord_id=None, lupdate_date_time=None, modified_by=None, ord_type=None, status=None):  # noqa: E501
