...
class BrokerageCharge(object):
    ...
    def __init__(self, total_margin=None, span_margin=None, exposure_margin=None, available_bal=None, var_margin=None, insufficient_bal=None, brokerage=None, broker_brokerage=None, levies_brokerage=None, other_brokerage=None):  # noqa: E501
