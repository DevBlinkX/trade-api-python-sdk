...
class SymbolDto(object):
    ...
    def __init__(self, symbol=None, disp_sym=None, instrument=None, base_sym=None, company_name=None, isin=None,
                 exc=None, exc_tkn=None, series=None, lot_size=None, tick_size=None, expiry_date=None, option_type=None,
                 strike_price=None, stream_sym=None, segment=None, fno=None, mtf=None, multiplier=None,
                 freeze_qty=None):  # noqa: E501
    ...
    def segment(self, segment):
        ...
        :type: str
        """
        allowed_values = ["equity", "derivative", "derivative", "index", "commodity", "currency", "spread",
                          "derivative", "none"]  # noqa: E501
