...
class Profile(object):
    ...
    def __init__(self, addresses=None, gender=None, turn_over_brokerage_saving=None, dpid=None, bank_accounts=None,
                 premium_plan_renewed=None, offer_type=None, poa_flag=None, in_active_from=None, segment=None, pan=None,
                 plan_end_date=None, email=None, active_from=None, plan_actual_price=None, plan_type=None, address=None,
                 mobile=None, ddpi_flag=None, client_code=None, dob=None, name=None, show_offer_price=None,
                 repository_type=None, plan_start_date=None, premium_plan_active=None):  # noqa: E501
