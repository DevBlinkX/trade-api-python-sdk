...
class Holding(object):
    ...
    def __init__(self, symbol=None, ltp=None, qty=None, holding_qty=None, used_qty=None, btst=None, pledge_qty=None,
                 prd_type=None, avg_price=None, invested=None, market_value=None, pnl_perc=None, un_realized_pnl=None,
                 haircut=None, pledgeable=None, close_price=None, free_qty=None):  # noqa: E501
