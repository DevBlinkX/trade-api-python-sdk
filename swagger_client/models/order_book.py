...
class OrderBook(object):
    ...
    def __init__(self, symbol=None, ord_id=None, exch_ord_id=None, par_ord_id=None, status=None, ord_action=None, ord_type=None, prd_type=None, ord_validity=None, modified_by=None, price=None, trigger_price=None, avg_price=None, remarks=None, rej_reason=None, ord_date=None, exc_ord_time=None, bo_ord_status=None, exitable=None, qty=None, dis_qty=None, traded_qty=None, remain_qty=None, cancelled_qty=None, mkt_pro=None, und_asset=None, amo=None, modifiable=None, cancellable=None):  # noqa: E501
