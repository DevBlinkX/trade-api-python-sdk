...
class TradeDetailsData(object):
    ...
    def __init__(self, und_asset=None, exc_ord_time=None, ord_action=None, cancelled_qty=None, is_amo=None,
                 avg_price=None, exitable=None, company_name=None, bo_ord_status=None, ord_id=None, cancellable=None,
                 exc_token=None, option_type=None, exc=None, ord_date=None, prd_type=None, modified_by=None,
                 base_sym=None, expiry=None, modifiable=None, ord_status=None, disp_sym=None, ord_duration=None,
                 child_type=None, instrument_type=None, trigger_price=None, limit_price=None, lot_size=None,
                 multipleir=None, strike=None, dis_qty=None, par_ord_id=None, mkt_pro=None, traded_qty=None,
                 remain_qty=None, rej_reason=None, qty=None, exch_ord_id=None, ord_type=None, remarks=None, tr_sym=None,
                 status=None, traded_price=None, exch_trd_id=None, trade_time=None):  # noqa: E501
