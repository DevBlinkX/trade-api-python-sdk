...
class Position(object):
    ...
    def __init__(self, symbol=None, prd_type=None, type=None, ltp=None, booked_pnl=None, un_realized_pnl=None, pnl_perc=None, net_pnl=None, prev_pos=None, prev_avg_price=None, curr_pos=None, curr_avg_price=None, net_qty=None, buy_qty=None, sell_qty=None, day_buy_qty=None, day_sell_qty=None, cf_buy_qty=None, cf_sell_qty=None, buy_avg_price=None, sell_avg_price=None, day_buy_avg_price=None, day_sell_avg_price=None, cf_buy_avg_price=None, cf_sell_avg_price=None, buy_amt=None, sell_amt=None, cf_buy_amt=None, cf_sell_amt=None, avg_price=None, und_asset=None, square_off=None, transferable=None, ord_action=None):  # noqa: E501
