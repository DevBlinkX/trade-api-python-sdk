...
class PlReportItem(object):
    ...
    def __init__(self, symbol=None, client_name=None, buy_date=None, expiry_date=None, intra_day_pl=None, open_cost=None, sell_value=None, scrip_code=None, buy_value=None, buy_rate=None, scrip_name=None, open_rate=None, realised_pl_futures=None, long_term_pl=None, call_put=None, realised_pl_total=None, unrealised_pl_options=None, realised_pl_options=None, unrealised_pl_futures=None, segment_name=None, sell_qty=None, sell_rate=None, buy_qty=None, product_code=None, product_type_short=None, client_code=None, short_term_pl=None, open_qty=None, sell_date=None, unrealised_pl_total=None, open_date=None, strike_price=None, isin=None):  # noqa: E501
