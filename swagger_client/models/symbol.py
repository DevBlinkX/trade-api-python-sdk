...
class Symbol(object):
    ...
    def __init__(self, freeze_qty=None, symbol=None, disp_sym=None, exc_tkn=None, lot_size=None, fno=None,
                 multiplier=None, company_name=None, stream_sym=None, instrument=None, tick_size=None, expiry_date=None,
                 option_type=None, exc=None, series=None, segment=None, base_sym=None, isin=None, strike_price=None,
                 mtf=None):  # noqa: E501
