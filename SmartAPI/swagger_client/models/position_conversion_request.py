...
class PositionConversionRequest(object):
    ...
    def __init__(self, type=None, ord_action=None, prd_type=None, to_prd_type=None, qty=None, symbol=None, exc_token=None, exc=None, lot_size=None, instrument=None, id=None):  # noqa: E501
