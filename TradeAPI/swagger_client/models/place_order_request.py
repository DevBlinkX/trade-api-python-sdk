...
class PlaceOrderRequest(object):
    ...
    def __init__(self, symbol=None, exc=None, ord_action=None, ord_validity=None, ord_type=None, prd_type=None, qty=None, dis_qty=None, lot_size=None, trigger_price=None, instrument=None, limit_price=None, amo=None, build=None, exc_token=None, bo_stp_loss=None, bo_tgt_price=None, trailing_sl=None):  # noqa: E501
